...
public class EditActivity extends Activity {
	...
	static final String PREF_FREQUENCY = "at.abraxas.amarino.plugins.compass.frequency";
	static final String KEY_PLUGIN_ID = "at.abraxas.amarino.plugins.compass.id";
	static final String KEY_VISUALIZER = "at.abraxas.amarino.plugins.compass.visualizer";
	
	private static final String TAG = "Compass EditActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compass_edit);
	...
	public void finish() {
		if (cancelled) {
			...
			returnIntent.putExtra(AmarinoIntent.EXTRA_PLUGIN_NAME, getString(R.string.compass_plugin_name));
			returnIntent.putExtra(AmarinoIntent.EXTRA_PLUGIN_DESC, getString(R.string.compass_plugin_desc));
			returnIntent.putExtra(AmarinoIntent.EXTRA_PLUGIN_SERVICE_CLASS_NAME, "at.abraxas.amarino.plugins.compass.BackgroundService"); 
			...
			returnIntent.putExtra(AmarinoIntent.EXTRA_VISUALIZER_MAX_VALUE, 359f);
