...
public class EditActivity extends Activity {
	...
	static final String KEY_VISUALIZER = "at.abraxas.amarino.plugins.timetick.visualizer";
	static final String KEY_PLUGIN_ID = "at.abraxas.amarino.plugins.timetick.id";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timetick_edit);
	...
	public void finish() {
		if (cancelled) {
			...
			returnIntent.putExtra(AmarinoIntent.EXTRA_PLUGIN_NAME, getString(R.string.timetick_plugin_name));
			returnIntent.putExtra(AmarinoIntent.EXTRA_PLUGIN_DESC, getString(R.string.timetick_plugin_desc));
			returnIntent.putExtra(AmarinoIntent.EXTRA_PLUGIN_SERVICE_CLASS_NAME, "at.abraxas.amarino.plugins.timetick.BackgroundService"); 
			...
			returnIntent.putExtra(AmarinoIntent.EXTRA_VISUALIZER_MAX_VALUE, 60f);
